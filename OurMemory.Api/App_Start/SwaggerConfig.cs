...
using OurMemory;
using OurMemory.OperationFilterSwagger;
        ...
        public static void Register()
        {
            ...
            GlobalConfiguration.Configuration
                .EnableSwagger(c =>
                {
                    ...
                    //
                    c.SingleApiVersion("v1", "OurMemory");
                ...
                .EnableSwaggerUi(c =>
                {
                    ...
                    //
                    c.InjectStylesheet(thisAssembly, "OurMemory.Content.CustomContenSwagger.swagger.css");

                    // Use the "InjectJavaScript" option to invoke one or more custom JavaScripts after the swagger-ui
                    // has loaded. The file must be included in your project as an "Embedded Resource", and then the resource's
                    // "Logical Name" is passed to the method as shown above.
                    //
                    c.InjectJavaScript(thisAssembly, "OurMemory.Content.CustomContenSwagger.basic.js");
